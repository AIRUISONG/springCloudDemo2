package com.restTemplate.Handler;


import com.restTemplate.Model.Student;
...
public class RestHandler {
    ...
    public Collection<Student> findAll(){
        String eurekaClient = this.getUrl("eurekaClient");
        return restTemplate.getForEntity(eurekaClient + "/student/findAll",Collection.class).getBody();
    }
    @GetMapping("/findAll2")
